...
const Features = () => {
  ...
  return (
    <section id="features" className="relative py-32 px-6 bg-gradient-to-b from-neutral-50 via-white to-neutral-50 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        <div className="text-center mb-20 animate-on-scroll opacity-0">
          <h2 className="text-5xl md:text-6xl font-bold bg-gradient-to-r from-neutral-900 via-primary-800 to-neutral-900 bg-clip-text text-transparent mb-6 tracking-tight">
            14 Powerful Modules
          </h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {features.map((feature, index) => (
            <div
              key={index}
              className="animate-on-scroll opacity-0 group relative bg-white/80 backdrop-blur-sm hover:bg-white p-8 rounded-3xl transition-all duration-300 hover:shadow-2xl hover:-translate-y-2 border border-neutral-200/50 hover:border-primary-300"
              style={{ animationDelay: `${index * 50}ms` }}
            >
              <div className="absolute inset-0 bg-gradient-to-br from-primary-500/0 to-accent-500/0 group-hover:from-primary-500/5 group-hover:to-accent-500/5 rounded-3xl transition-all duration-300"></div>
...
const DemoVideo = () => {
  return (
    <section id="demo" className="relative py-32 px-6 bg-gradient-to-br from-accent-900 via-neutral-900 to-accent-800 overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        ...
        <div className="animate-on-scroll opacity-0 relative rounded-3xl overflow-hidden shadow-2xl hover:shadow-primary-500/20 transition-shadow duration-500 bg-gradient-to-br from-primary-900 to-accent-900 aspect-video group">
          <div className="absolute inset-0 flex items-center justify-center z-10">
            <button className="bg-white hover:bg-primary-50 rounded-full p-8 shadow-2xl transition-all transform group-hover:scale-110 duration-300">
              <svg className="w-16 h-16 text-primary-600" fill="currentColor" viewBox="0 0 24 24">
                <path d="M8 5v14l11-7z" />
              </svg>
            </button>
          </div>
          <div className="absolute inset-0 bg-gradient-to-br from-primary-600/30 to-accent-600/30 animate-pulse" style={{ animationDuration: '6s' }}></div>
        </div>
      </div>
    </section>
  );
...
const Pricing = () => {
  ...
  return (
    <section id="pricing" className="relative py-32 px-6 bg-gradient-to-b from-white via-neutral-50 to-white overflow-hidden">
          ...
          {plans.map((plan, index) => (
            <div
              ...
              className={`animate-on-scroll opacity-0 relative rounded-3xl p-10 transition-all duration-300 ${
                plan.highlighted
                  ? 'bg-gradient-to-br from-primary-600 to-accent-700 text-white shadow-2xl scale-105 hover:scale-110'
            ...
            >
              {plan.highlighted && (
                <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">
                  <span className="bg-white text-primary-600 px-4 py-1 rounded-full text-sm font-semibold shadow-lg">
                    Most Popular
                  </span>
                </div>
              )}
...
const AboutUs = () => {
  return (
    <section id="about-us" className="relative py-32 px-6 bg-gradient-to-b from-white via-neutral-50 to-white overflow-hidden">
      <div className="absolute top-0 right-0 w-96 h-96 bg-primary-500/5 rounded-full blur-3xl"></div>
      <div className="absolute bottom-0 left-0 w-96 h-96 bg-accent-500/5 rounded-full blur-3xl"></div>

      <div className="relative z-10 max-w-4xl mx-auto text-center animate-on-scroll opacity-0">
        <h2 className="text-5xl md:text-6xl font-bold bg-gradient-to-r from-neutral-900 via-primary-800 to-neutral-900 bg-clip-text text-transparent mb-8 tracking-tight">
          Built for Growth
        </h2>
...
const Contact = () => {
  ...
  return (
    <section id="contact" className="relative py-32 px-6 bg-gradient-to-br from-accent-900 via-neutral-900 to-accent-800 overflow-hidden">
      <div className="absolute inset-0 bg-gradient-to-tr from-primary-900/20 via-transparent to-accent-900/20"></div>
        ...
        <form onSubmit={handleSubmit} className="animate-on-scroll opacity-0 space-y-6">
          <div>
            <input
              ...
              className="w-full px-6 py-4 bg-white/10 backdrop-blur-md border-2 border-white/20 rounded-2xl focus:border-primary-400 focus:ring-4 focus:ring-primary-500/20 outline-none transition-all text-white placeholder:text-neutral-400"
            />
          </div>
          <div>
            <input
          ...
          <div>
            <textarea
              ...
              className="w-full px-6 py-4 bg-white/10 backdrop-blur-md border-2 border-white/20 rounded-2xl focus:border-primary-400 focus:ring-4 focus:ring-primary-500/20 outline-none transition-all resize-none text-white placeholder:text-neutral-400"
            />
          </div>
          <button
            type="submit"
            disabled={isSubmitting}
            className={`w-full bg-gradient-to-r from-primary-500 to-accent-500 hover:from-primary-400 hover:to-accent-400 text-white py-5 px-6 rounded-2xl font-semibold transition-all transform hover:scale-105 shadow-2xl hover:shadow-primary-500/50 ${
          ...
          <p className="text-center text-neutral-300 pt-6">
            Or email us at{' '}
    ...
    <footer className="bg-neutral-900 text-white py-16 px-6 border-t border-neutral-800">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16 pb-16 border-b border-neutral-800">
          <h3 className="text-4xl md:text-5xl font-bold mb-6 tracking-tight bg-gradient-to-r from-white via-primary-300 to-white bg-clip-text text-transparent">
          ...
          <button className="bg-gradient-to-r from-primary-500 to-accent-500 hover:from-primary-600 hover:to-accent-600 text-white px-10 py-5 rounded-full font-semibold transition-all transform hover:scale-105 shadow-xl hover:shadow-primary-500/50">
            Join Waitlist Now →
          </button>
        </div>
        ...
        <div className="grid md:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3 text-neutral-500">
              <li><a href="#about-us" className="hover:text-primary-400 transition-colors">About</a></li>
